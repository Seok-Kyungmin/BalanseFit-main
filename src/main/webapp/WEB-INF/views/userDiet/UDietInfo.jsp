    ...
    <script type="text/javascript">
        ...
        function doEdit() {
            if ("<%=edit%>" == 2) {
                ...
                console.log(edit);
                alert("수정하기 이동");
                let s = "/userDiet/UDietEdit?dSeq=<%=CmmUtil.nvl(rDTO.getDiet_seq())%>&user_id=<%=user_id%>";
                alert(s)
                location.href = s;
        ...
        function doDelete() {
            if ("<%=edit%>" == 2) {
                if (confirm("작성한 글을 삭제하시겠습니까?")) {
                    location.href = "/userDiet/DietDelete?dSeq=<%=CmmUtil.nvl(rDTO.getDiet_seq())%>";
        ...
        //목록으로 이동
        function doList() {
            window.location.href = "/userDiet/UDietList";
