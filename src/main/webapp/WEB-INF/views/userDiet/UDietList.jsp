...
<%@ page import="com.balansefit.dto.UserDietDTO" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDetail(seq) {
            location.href = "/userDiet/UDietInfo?dSeq=" + seq;
        }
    ...
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div style="text-align: right;margin-bottom: 30px;">
                <a href="/userDiet/UDietReg" class="btn btn-primary py-2 px-4">추가하기</a>
            </div>
        </div>
        <%
            DietDTO dDTO = null;
...
<%--                                            <small class="fst-italic"><%=CmmUtil.nvl(dDTO.getFood_dc_2())%></small>--%>
                        ...
                        <button type="button" onclick="doDelete()" class="btn btn-primary py-2 px-4">삭제하기</button>
