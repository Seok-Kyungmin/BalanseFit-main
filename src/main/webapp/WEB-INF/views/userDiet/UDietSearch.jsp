...
<head>
    ...
    <%
        List<UserMadeDietDTO> dList = (List<UserMadeDietDTO>) request.getAttribute("dList");

        //운동 정보 조회 결과 보여주기
        if (dList == null) {
            dList = new ArrayList<UserMadeDietDTO>();
                ...
                <div class="con">
                    <div class="divTable minimalistBlack">
                        ...
                        <div class="divTableBody">
                            <div class="divTableRow">
                                <div class="divTableCell"><%=CmmUtil.nvl(dDTO.getUser_diet_seq())%></div>
                                <div class="divTableCell">
                                    <a href="javascript:doDetail('<%=CmmUtil.nvl(dDTO.getUser_diet_seq())%>');">
                                        <%=CmmUtil.nvl(dDTO.getUser_diet_name())%></a></div>
