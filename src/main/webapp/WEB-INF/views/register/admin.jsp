...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkId(){
            ...
            let adm_id = $('#adm_id').val();  //id값이 "id"인 입력란의 값을 저장
            let data = {"adm_id" : adm_id}
        ...
        function checkEmail(){
            ...
            let adm_email = $('#adm_email').val();  // .email_input에 입력되는 값
            let data = {"adm_email" : adm_email}
        ...
        function doRegAdminCheck(f){
            ...
            if(!RegExp.test(f.adm_id.value)){ //아이디 유효성검사
            ...
            if(!e_RegExp.test(f.adm_email.value)){ //이메일 유효성 검사
