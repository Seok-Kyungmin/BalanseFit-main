                ...
                <div class="form-input-content">
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5">
                            <a class="text-center" href="/userIndex"> <h4>"<%=sessionEmail %>"님의 비밀번호 입력</h4></a>
                            <form name='f' class="mt-5 mb-5 login-input" action='/user/changePwdProc' onsubmit="return doChangeUserCheck(this);">

                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="id" name="user_id">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="password" name="user_pw">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="passwordCheck" name="user_pw2">
                                </div>
