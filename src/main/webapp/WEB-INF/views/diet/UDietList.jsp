...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDetail(seq) {
            location.href = "/user/DietInfo?dSeq=" + seq;
        }
    ...
    <div class="container-xxl pt-5 pb-3">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h5 class="section-title ff-secondary text-center text-primary fw-normal">Diets</h5>
                <h1 class="mb-5">Our Diet</h1>
            </div>
<%--            <div style="text-align: right;margin-bottom: 30px;">--%>
<%--                <a href="/user/DietReg" class="btn btn-primary py-2 px-4">추가하기</a>--%>
<%--            </div>--%>
            <div class="row g-4">
                <%
                    DietDTO dDTO = null;
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center rounded overflow-hidden">
                        ...
                        <h5 class="mb-0"><%=CmmUtil.nvl(dDTO.getDiet_seq())%></h5>
                        <h5 class="mb-0"><%=CmmUtil.nvl(dDTO.getDiet_name())%></h5>
                        <small><%=CmmUtil.nvl(dDTO.getDiet_calories())%></small>
                        <div class="d-flex justify-content-center mt-3">
                            <a class="btn btn-square btn-primary mx-1" href="javascript:doDetail('<%=CmmUtil.nvl(dDTO.getDiet_seq())%>');" style="font-size: 12px">상세<br>보기</a>
                        </div>
                    </div>
                </div>
                <%
