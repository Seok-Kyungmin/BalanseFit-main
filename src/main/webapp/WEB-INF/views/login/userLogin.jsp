                ...
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <form id="formAuthentication" class="mb-3" method="post" action="/loginPage1" onsubmit="return doLoginUserCheck(this)">
                        ...
                        <div class="mb-3">
                            <a href="/mypage">
                            <button class="btn btn-primary d-grid w-100" style="padding-top: 9px; padding-bottom: 9px;" type="submit">로그인</button>
                            </a>
                            <a href="javascript:kakaoLogin();">
                                <img src="../img/kakao_login.png" alt="카카오계정 로그인" style="height: 45px; width: 350px; margin-top: 8px;"/>
                            </a>
    ...
    function kakaoLogin() {
        window.Kakao.Auth.login({
            ...
            success: function(response) {
                ...
                window.location.href='/userIndex' //리다이렉트 되는 코드
            },
            fail: function(error) {
                console.log(error);
            }
