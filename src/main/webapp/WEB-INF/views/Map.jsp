    ...
    <div class="container-xxl position-relative p-0">
        ...
        <div class="container-xxl py-5 bg-dark hero-header mb-5">
            <div class="container text-center my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Diet Restaurant</h1>
            </div>
        </div>
    </div>
    <!-- Navbar & Hero End -->
    ...
    <div class="container-xxl pt-5 pb-3">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h5 class="section-title ff-secondary text-center text-primary fw-normal">Map</h5>
                <h1 class="mb-5">Diet Restaurant</h1>
            </div>
            <div class="map_wrap">
                    ...
                    <div class="option">
                        <div>
                            <form onsubmit="searchPlaces(); return false;">
                                키워드 : <input type="text" value="다이어트 식당" id="keyword" size="15">
...
<%--            <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?ca041a45c0ed421d3ed105f7173662b0&libraries=services"></script>--%>
            <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ca041a45c0ed421d3ed105f7173662b0&libraries=services"></script>
            <script>
                // 마커를 담을 배열입니다
                var markers = [];
                ...
                var mapContainer = document.getElementById('map'), // 지도를 표시할 div
                    mapOption = {
                        center: new kakao.maps.LatLng(37.560326, 126.825011), // 지도의 중심좌표
                        level: 3 // 지도의 확대 레벨
                    };
