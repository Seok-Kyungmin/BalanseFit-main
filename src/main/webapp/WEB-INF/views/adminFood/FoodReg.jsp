    ...
    <div class="container-xxl position-relative p-0">
        ...
        <div class="container-xxl py-5 bg-dark hero-header mb-5">
            <div class="container text-center my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Food Add</h1>
            </div>
        </div>
    </div>
    <!-- Navbar & Hero End -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">식품정보를 추가해주세요</h1>
                <form action="/admin/FoodInsert" name="f" method="post" target="ifrPrc" onsubmit="return doSubmit(this)">
                    <div>
                        <div style="text-align: center;">
                            <div class="form-floating" style="display: inline-block;">
                                <input type="text" class="form-control" id="name" name="food_name" placeholder="Food Name" style="width: 340px; ">
                                <label for="name">식품명</label>
                            </div>
                        </div>
                        <div style="text-align: center; margin-top: 15px;">
                            <div class="form-floating" style="display: inline-block;">
                                <input type="text" class="form-control" id="calories" name="food_calories" placeholder="Food Calories" style="width: 340px; ">
                                <label for="calories">칼로리</label>
                            </div>
                        </div>
                        <div style="text-align: center;margin-top: 15px;">
                            <div class="form-floating" style="display: inline-block;">
                                <input type="text" class="form-control" id="carbohydrate" name="food_carbohydrate" placeholder="Food Carbohydrate" style="width: 340px; ">
                                <label for="carbohydrate">탄수화물</label>
                            </div>
                        </div>
                        <div style="text-align: center; margin-top: 15px;">
                            <div class="form-floating" style="display: inline-block;">
                                <input type="text" class="form-control" id="protein" name="food_protein" placeholder="Food Protein" style="width: 340px; ">
                                <label for="protein">단백질</label>
                            </div>
                        </div>
                        <div style="text-align: center;margin-top: 15px;">
                            <div class="form-floating" style="display: inline-block;">
                                <input type="text" class="form-control" id="fat" name="food_fat" placeholder="Food Fat" style="width: 340px; ">
                                <label for="fat">지방</label>
                            </div>
                        </div>
                        <div style="text-align: center; margin-top: 15px;">
                            <div class="form-floating" style="display: inline-block;">
                                <input type="text" class="form-control" id="sugar" name="food_sugar" placeholder="Food Sugar" style="width: 340px; ">
                                <label for="sugar">당</label>
                            </div>
                        </div>
                        <div style="text-align: center; margin-top: 15px;">
                            <div class="form-floating" style="display: inline-block;">
                                <input type="text" class="form-control" id="natrium" name="food_natrium" placeholder="Food Natrium" style="width: 340px; ">
                                <label for="natrium">나트륨</label>
                            </div>
                        </div>
                        <div style="text-align: center; margin-top: 15px;">
                            <div class="form-floating" style="display: inline-block;">
                                <input type="text" class="form-control" id="weight" name="food_weight" placeholder="Food Weight" style="width: 340px; ">
                                <label for="weight">1회 제공량</label>
                            </div>
                        </div>
